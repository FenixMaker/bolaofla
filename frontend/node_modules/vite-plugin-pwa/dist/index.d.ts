...
import { GenerateSWConfig, InjectManifestConfig, RuntimeCachingEntry } from 'workbox-build';
...
declare const cachePreset: RuntimeCachingEntry[];

declare function VitePWA(userOptions?: Partial<VitePWAOptions>): Plugin[];

export { VitePWAOptions as Options, VitePWA, cachePreset };
