...
async function generateRegisterSW(options, mode, source = "register") {
  const sw = slash(_path.join.call(void 0, options.base, options.filename));
...
`,
        ...
        if (options.injectRegister === "script" && !_fs.existsSync.call(void 0, _path.join.call(void 0, viteConfig.root, "public", FILE_SW_REGISTER))) {
